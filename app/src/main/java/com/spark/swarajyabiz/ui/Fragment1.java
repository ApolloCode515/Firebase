...
public class Fragment1 extends Fragment implements CreateBanner.ButtonClickListener {
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment1.ScaleListener());
