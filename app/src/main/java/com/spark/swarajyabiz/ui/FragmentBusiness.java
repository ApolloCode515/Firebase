...
public class FragmentBusiness extends Fragment implements  BusinessBannerAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reqbusinessbtn = view.findViewById(R.id.reqbusibtn);
...
//        }
       ...
       reqbusinessbtn.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               Intent intent = new Intent(getContext(), CustomBannerImage.class);
               intent.putExtra("hint", "इथे तुमचा व्यवसाय टाइप करा");
               startActivity(intent);
           }
       });
                        ...
                        if (userId != null && businessName != null && !businessName.trim().isEmpty()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@androidx.annotation.NonNull DataSnapshot snapshot) {
                                    ...
                                    reqbusinessbtn.setVisibility(View.VISIBLE);
                                }
