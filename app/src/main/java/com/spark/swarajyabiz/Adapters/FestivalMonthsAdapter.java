...
public class FestivalMonthsAdapter extends RecyclerView.Adapter<FestivalMonthsAdapter.MonthViewHolder> {
    ...
    public FestivalMonthsAdapter(Context context, List<String> months, OnClick onClick) {
        this.months = months;
