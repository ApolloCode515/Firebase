...
public class FestivalEventAdapter extends RecyclerView.Adapter<FestivalEventAdapter.MonthViewHolder> {
    ...
    public FestivalEventAdapter(Context context, List<String> months, OnClick onClick) {
        this.months = months;
