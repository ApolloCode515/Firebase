package com.spark.swarajyabiz.PersonalFrame;
...
public class Fragment_personal_1 extends Fragment implements CreateBanner.ButtonClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_personal_1, container, false);
        ...
        frame = view.findViewById(R.id.logoframelayout);
        ...
        if (bundle != null) {
            ...
            shopname = bundle.getString("shopownername", "default_value");
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment_personal_1.ScaleListener());
...
//        shopcontactnumbertext.setBackground(null);
...
//                    GradientDrawable border = new GradientDrawable();
//                    border.setStroke(2, Color.GRAY);
//                    shopcontactnumbertext.setBackground(border);
                }
