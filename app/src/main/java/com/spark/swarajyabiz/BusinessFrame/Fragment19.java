...
public class Fragment19 extends Fragment implements CreateBanner.ButtonClickListener{
    ...
    public Fragment19() {
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_19, container, false);
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment19.ScaleListener());
