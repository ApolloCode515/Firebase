...
public class Fragment3 extends Fragment implements CreateBanner.ButtonClickListener {
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment3.ScaleListener());
