...
public class Fragment12 extends Fragment implements CreateBanner.ButtonClickListener{
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment12.ScaleListener());
