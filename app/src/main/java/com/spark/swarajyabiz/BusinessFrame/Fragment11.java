...
public class Fragment11 extends Fragment implements CreateBanner.ButtonClickListener{
...
//        shopownernametext.setText(shopownername);
        ...
        scaleGestureDetector = new ScaleGestureDetector(requireContext(), new Fragment11.ScaleListener());
