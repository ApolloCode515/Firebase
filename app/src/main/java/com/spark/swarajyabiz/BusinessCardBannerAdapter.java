...
public class BusinessCardBannerAdapter extends RecyclerView.Adapter<BusinessCardBannerAdapter.BannerviewHolder> {
    ...
    public BusinessCardBannerAdapter(Context context, SharedPreferences sharedPreferences, OnItemClickListener onItemClickListener) {
    ...
    public BannerviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.business_card_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull BannerviewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.color.white) // Replace with your placeholder image resource// Replace with your error image resource
