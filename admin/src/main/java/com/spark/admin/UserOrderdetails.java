...
public class UserOrderdetails extends AppCompatActivity {
        ...
        EditText sendedittext;
         String ownercontactNumber,formattedTime,formattedDate, clickTime;
...
//                    });
                           ...
                           // fetchOrderHistory(buyerContactNumber,orderkey);
                            ...
                            buttoncard.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if (!message.isEmpty()) {
                                        sendMessageToChatsNode(message,buyerContactNumber, orderkey);
                                        sendMessageTochatsNode(message,buyerContactNumber, orderkey);
            ...
            combinedAdapter = new CombinedAdapter(combinedList, sharedPreference);

            recyclerView.setAdapter(combinedAdapter);
            // Fetch and display chat messages
            //    fetchChatMessages();

            recyclerView.scrollToPosition(combinedList.size() - 1); // Scroll to the bottom
...
//    }
    ...
    // Sample method to create sample order history data
        ...
        private void sendMessageToChatsNode(String message,String buyerContactNumber, String orderkey) {
            while (true) {
                                    ...
                                    for (DataSnapshot messageSnapshot : dataSnapshot.getChildren()) {
                                        ...
                                        if (!addedChatMessageKeys.contains(messageKey)) {
                                            ...
                                            if (message != null && sender != null && receiver != null) {
                                                ChatMessage chatMessage = new ChatMessage(sender, receiver, message, time);
