...
public class PlaceOrder extends AppCompatActivity {
    ...
    String itemName,firstImageUrl, shopuserid, orderKey, formattedTime,formattedDate, chatorderkey, name;
...
//        recyclerView.setAdapter(adapter);
        ...
        // Load order history data from Firebase and populate the list (orderHistoryList)
