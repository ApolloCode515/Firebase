        ...
        boostbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isValidImageUrl(shopimage)) {
                    ...
                    String message = "Maratha Mart \n" +
                            "च नवीन ॲप आल आहे. " +shopname+ " shop मधील प्रॉडक्ट खरेदी करण्यासाठी आजच ॲप डाऊनलोड करा. व तुमच्या संपर्कातील लोकांना Maratha Mart च ॲप अवश्य शेअर करा. \n" + appUrl;
