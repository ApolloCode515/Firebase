...
public class EditProfile extends AppCompatActivity implements ImageAdapter.ImageClickListener{
    ...
    private Uri croppedImageUri, imageUris;
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                if (croppedImageUri != null) {
                                    ...
                                    try {
                                        ...
                                        bitmap.compress(Bitmap.CompressFormat.JPEG, 60, baos); // Adjust the compression quality as needed
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK) {
           Uri imageUri = data.getData();
            ...
            circleImageView.setImageDrawable(null); // Clear the existing image
            if (imageUri != null) {
